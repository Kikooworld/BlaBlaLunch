...
-- Événements
--
CREATE DEFINER=`root`@`localhost` EVENT `Empty_cars` ON SCHEDULE EVERY 1 DAY STARTS '2016-08-30 14:00:00' ON COMPLETION PRESERVE ENABLE DO DELETE FROM cars$$

CREATE DEFINER=`root`@`localhost` EVENT `Empty_participations` ON SCHEDULE EVERY 1 DAY STARTS '2016-08-30 14:00:00' ON COMPLETION PRESERVE ENABLE DO TRUNCATE TABLE participations$$
